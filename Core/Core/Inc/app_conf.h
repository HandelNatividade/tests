 ...
 * Define Tx Power
 */
#define CFG_TX_POWER                      (0x1f) /* 0dBm */ // do 0x1f for +6db
...
/** BEGIN Stefan's Config */
/***************************************/


#define USR_POWER_OFF_ON_DISCONNECT				0
#define USR_STOP2								1
...
#define DATA_NOTIFICATION_MAX_PACKET_SIZE           216//244 // 216 for compat with bluenrg
...
typedef enum
{
  ...
  USR_TASK_UPDATE_CHAR_ID,
  USR_TASK_READ_ACCELEROMETER_ID,
  USR_TASK_DMA_COMPLETE_ID,
  USR_TASK_BUFFER_FIFO_FULL_ID,
  USR_TASK_REINIT_ADXL,	// calls ADXLInit() in dt_server_app_mode1.c
...
typedef enum
{
  ...
  USR_IDLEEVT_READ_ADXL_COMPLETE,
  USR_IDLEEVT_FIFO_FULL,
